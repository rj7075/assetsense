        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              ...
              size="lg"
              className="bg-orange-500 hover:bg-orange-600 text-white cursor-pointer font-semibold px-4 py-2 text-sm transform hover:scale-105"
            >
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-2 border-white text-white cursor-pointer hover:bg-white hover:text-blue-600 px-6 py-2 text-sm transform hover:scale-105"
            >
